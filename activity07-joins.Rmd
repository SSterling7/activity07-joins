...
**Response**: Yes for la quinta no for dennys
...
**Response**: If it had countries I would do something to look for not us locations, aka no us states?
...
**Response**: abbreviations are linked to "state" in dennys. No Dennys are outside US.
